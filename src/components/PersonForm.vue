<template>
  <div class="form">
    ...
    >
      ...
      <div
        v-for="(link, index) in formData.个人信息.社交媒体链接"
        :key="index"
        class="form-group"
      >
        <div class="form-row">
      ...
      <div
        v-for="(city, index) in formData.求职意向.意向城市"
        :key="index"
        class="form-group"
      >
        <div class="form-row">
          ...
          <input
            v-model="formData.求职意向.意向城市[index]"
            id="intention-city"
            type="text"
            class="form-control"
          />
          ...
          <button
            type="button"
            @click="removeIntentionCity(index)"
            class="btn btn-danger"
          >
            删除
          </button>
      ...
      <div
        v-for="(position, index) in formData.求职意向.意向岗位"
        :key="index"
        class="form-group"
      >
        <div class="form-row">
          ...
          <input
            v-model="formData.求职意向.意向岗位[index]"
            id="intention-position"
            type="text"
            class="form-control"
          />
          <button
            type="button"
            @click="addIntentionPosition"
            class="btn btn-primary"
          >
            添加意向岗位
          </button>
          <button
            type="button"
            @click="removeIntentionPosition(index)"
            class="btn btn-danger"
          >
            删除
          </button>
      ...
      <div
        v-for="(education, index) in formData.教育背景"
        :key="index"
        class="form-group"
      >
        <div class="form-row">
          ...
          <input
            v-model="formData.教育背景[index].教育层次"
            id="education-level"
            type="text"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.教育背景[index].学校"
            id="school"
            type="text"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.教育背景[index].专业"
            id="major"
            type="text"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.教育背景[index].学位"
            id="degree"
            type="text"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.教育背景[index].时间"
            id="education-time"
            type="date"
            class="form-control"
          />
      ...
      <div
        v-for="(skill, index) in formData.技能优势"
        :key="index"
        class="form-group"
      >
        <div class="form-row">
      ...
      <div
        v-for="(language, index) in formData.语言"
        :key="index"
        class="form-group"
      >
        <div class="form-row">
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.语言[index].熟练程度"
            id="proficiency"
            type="text"
            class="form-control"
          />
      ...
      <div
        v-for="(honor, index) in formData.荣誉奖项"
        :key="index"
        class="form-group"
      >
        <div class="form-row">
          ...
          <input
            v-model="formData.荣誉奖项[index].时间"
            id="honor-time"
            type="date"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.荣誉奖项[index].奖项"
            id="honor-award"
            type="text"
            class="form-control"
          />
      ...
      <div
        v-for="(achievement, index) in formData.学术成果"
        :key="index"
        class="form-group"
      >
        <div class="form-row">
          ...
          <input
            v-model="formData.学术成果[index].时间"
            id="achievement-time"
            type="date"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.学术成果[index].名称"
            id="achievement-name"
            type="text"
            class="form-control"
          />
      ...
      <div
        v-for="(certificate, index) in formData.证书"
        :key="index"
        class="form-group"
      >
        <div class="form-row">
      ...
      <div
        v-for="(project, index) in formData.项目经历"
        :key="index"
        class="form-group"
      >
        <div class="form-row">
          ...
          <input
            v-model="formData.项目经历[index].项目名称"
            id="project-name"
            type="text"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.项目经历[index].时间"
            id="project-time"
            type="date"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.项目经历[index].参与角色"
            id="project-role"
            type="text"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.项目经历[index].项目地址"
            id="project-address"
            type="text"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.项目经历[index].技术栈"
            id="tech-stack"
            type="text"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.项目经历[index].项目内容"
            id="project-content"
            type="text"
            class="form-control"
          />
      ...
      <div
        v-for="(job, index) in formData.工作经历"
        :key="index"
        class="form-group"
      >
        <div class="form-row">
          ...
          <input
            v-model="formData.工作经历[index].单位"
            id="company"
            type="text"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.工作经历[index].时间"
            id="work-time"
            type="date"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.工作经历[index].岗位"
            id="job-position"
            type="text"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.工作经历[index].地址"
            id="work-address"
            type="text"
            class="form-control"
          />
        ...
        <div class="form-row">
          ...
          <input
            v-model="formData.工作经历[index].主要工作内容"
            id="work-content"
            type="text"
            class="form-control"
          />
      ...
      <div
        v-for="(evaluation, index) in formData.自我评价"
        :key="index"
        class="form-group"
      >
        <div class="form-row">
  ...
  setup() {
    ...
    const submitForm = async () => {
      ...
      try {
        ...
        const response = await formResume(formData)
