<template>
  <template v-if="!formShow"> <div class="container">
    ...
    <div class="bottom">
      <button class="common-button" @click="parseResume"
  :class="{ 'common-button-disabled': !selectedFile }">开始解析</button>
...
// 发送文件到后端 API 进行解析
  axios.post('/resume/analysis', formData)
    .then(response => {
      // 处理解析成功的逻辑
       ElMessage({
          message: '提交成功',
