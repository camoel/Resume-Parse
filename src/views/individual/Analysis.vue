<template>
  <div class="container">
    ...
    <div class="bottom">
      <button class="common-button common-button-disabled">开始解析</button>
  ...
  <div class="form-popup" v-if="showForm">
    <!-- 这里添加您的表单内容 -->
    <PersonForm/>
     <el-button class="keep">保存</el-button>
     <el-button @click="showForm = false"class="close"  >关闭</el-button>
